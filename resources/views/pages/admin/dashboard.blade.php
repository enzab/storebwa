...
>
    <div class="container-fluid">
        <div class="dashboard-heading">
            ...
            <p class="dashboard-subtitle">This is StoreBWA Administrator Panel</p>
        </div>
                    ...
                    >
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">Sabri</div>
                                <div class="col-md-3">5 December, 2022</div>
                    ...
                    >
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">Riska SM</div>
                                <div class="col-md-3">1 December, 2022</div>
                                <div class="col-md-1 d-none d-md-block">
                                    <img
                                    src="/images/dashboard-arrow-right.svg"
                                    alt=""
                    ...
                    >
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">Reezwan</div>
                                <div class="col-md-3">24 November, 2022</div>
                                <div class="col-md-1 d-none d-md-block">
                                    <img
                                    src="/images/dashboard-arrow-right.svg"
                                    alt=""
